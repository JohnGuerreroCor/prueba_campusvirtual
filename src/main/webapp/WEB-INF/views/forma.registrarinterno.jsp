...
<md-dialog aria-label="Formulario Registrar" ng-cloak="true">
	...
	<md-dialog-content>
		<div class="md-dialog-content">
			...
			<br>
			<input type="checkbox" ng-if="registrar.proveedores == 1" ng-model="registrar.isproveedor" name="checkProveedor" id="checkProveedor"> <label  ng-if="registrar.proveedores == 1">Es usted Proveedor?</label>
			<div layout-gt-xs="row" ng-if="!registrar.isproveedor">
				...
				<input class="" type="text" id="usuarior" name="usuarior"
					ng-model="registrar.usuarior" placeholder="Ingrese su usuario"
				  ...
				  <div>
			        <md-button ng-disabled="!registrar.usuarior" class="md-raised" ng-click="loadValidadUsu(registrar.usuarior)">
