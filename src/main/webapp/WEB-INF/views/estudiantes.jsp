...
<link rel="stylesheet" type="text/css" href="/campusvirtual/app/assets/css/estudiantes.css" />
<body ng-controller="EstudiantesController as e">
	...
	<div id="master-content" layout="column">
		...
		<div id="scene" class="image-student scene border fill" flex hide-sm hide-xs>
			...
			<h1 class="title-vc-section text-main-black md-headline" flex>Guías y videotutoriales estudiantes</h1>
			<img class="layer expand-width" data-depth="0.10" src="/campusvirtual/app/assets/img/estudiantes/students.jpg" alt="Sección guías y video tutoriales para estudiantes usco campus virtual" title="Estudiantes de la USCO leyendo">
		</div>
		
		<div id="scene2" class="image-student-mobile scene border fill" flex hide-gt-sm>
			<div id="overlay">
			</div>
			<h1 class="title-vc-section-mobile text-main-black md-headline" flex hide-gt-sm>Guías y videotutoriales estudiantes</h1>
			<img class="layer expand-width" data-depth="0.10" src="/campusvirtual/app/assets/img/estudiantes/students.jpg" alt="Sección guías y video tutoriales para estudiantes usco campus virtual" title="Estudiantes de la USCO leyendo">
		</div>
		...
		<div class="subsections container-subsection text-main-white" flex layout="column" >
			<br>
			<br>
			<p class="text-main-black text-description" flex>En esta sección encontrará toda la información necesaria para el adecuado uso de las diferentes herramientas y módulos del campus virtual que están dirigidos a la comunidad estudiantil.</p>
			<br>
			<br>
			...
			<p class="text-main-black text-description space">Los tutoriales están organizadas por módulos, cada una de las pestañas a continuación corresponde a uno de ellos, esta pestañas además contienen número específico de videos.</p>
		      ...
		      <md-tabs class="list-sub-videos" md-dynamic-height md-border-bottom>
			      <md-tab ng-repeat="a in e.videos" label="{{a.nombre.replace('_',' ') | removeSpaces }}" ng-if="a.tipo == 'folder'">
			        <md-content class="md-padding">
				        <md-grid-list class="gridListdemoBasicUsage"
					        ...
					        <md-grid-tile class="modulo-guia gray" ng-repeat="b in a.archivos" ng-if="b.tipo == 'file'" ng-click="e.showVideo($event, b.nombre  | removeSpaces | addSpaces ,'videos/sakai/estudiantes/'+ a.nombre + '/' + b.nombre.replace('.mp4',''))">
	...
	<script type="text/javascript" src="/campusvirtual/app/controllers/estudiantes/EstudiantesController.js"></script>
